...
def main_DP(name, data1, data1_std):
    ...
    P_m = []
    B_m = []
    for root, dirs, files in os.walk(r"C:\Users\danie\Desktop\Daniel_Master_Directory\AMMPER\AMMPER_NEW\AMMPER\Results_Bulk_aB" + '\\' + str(name)):
        if len(files) > 1:
...
data1STD = pd.read_csv(r'C:\Users\danie\Desktop\Daniel_Master_Directory\AMMPER\AMMPER_NEW\AMMPER\AlamarblueRawdataWTKGySTD.csv',
                       names = namesk) # Average 0 Gy, use Average data instead of single data >>>>>>> <<<<<<<<<<<< Re run 4 rank tensor gridsearch
# "

data2STD = pd.read_csv(r'C:\Users\danie\Desktop\Daniel_Master_Directory\AMMPER\AMMPER_NEW\AMMPER\AlamarblueRawdataWT25GySTD.csv',
                       names = namesk) # Average 0 Gy, use Average data instead of single data >>>>>>> <<<<<<<<<<<< Re run 4 rank tensor gridsearch

data3STD = pd.read_csv(r'C:\Users\danie\Desktop\Daniel_Master_Directory\AMMPER\AMMPER_NEW\AMMPER\AlamarblueRawdataWT30GySTD.csv',
                       names = namesk) # Average 0 Gy, use Average data instead of single data >>>>>>> <<<<<<<<<<<< Re run 4 rank tensor gridsearch
