...
from cellPlot_HighQuality import cellPlot_HighQuality
from cellPlot_deepSpace import cellPlot_deepSpace
from GammaRadGen_HighQuality import GammaRadGen_HighQuality
import os
import time
import pandas as pd
import time
...
for g in range(1,gen+1):
    ...
    if radType == "Gamma":
        if g == radGen:
            ...
            dose = int(dose)
            radData = GammaRadGen_HighQuality(dose)
...
if radType == "150 MeV Proton":
    ...
    cellPlot_HighQuality(data,gen,radData,ROSData,radGen,N,plots_path)
